...
fig, ax = plt.subplots()
ax.barh(x=sales_1985.index, width=sales_1985.values, color='grey')
...
fig, ax = plt.subplots()
ax.barh(x=product_counts.index, width=product_counts.values, color='red')
...
fig, ax = plt.subplots()
ax.barh(x=product_sales.index, width=product_sales.values, color='green')
ax.set_title('Объем выручки')
ax.set_ylabel('Сумма продаж')
ax.set_xlabel('Категории товаров')
plt.xticks(rotation=90)
